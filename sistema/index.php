...
<?php if ($user['access_type'] == 'admin'): ?>
                        ...
                        <li><a href="javascript:void()" onclick="open_target('target=about');"><i class="fa fa-book"></i> <span>Sobre</span></a></li>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; <?php echo date('Y') ?> <a href="royal_design@hotmail.com.br">Rogério O. Nascimento</a>.</strong> Todos os direitos reservados.
            </footer>
            ...
            <aside class="control-sidebar control-sidebar-dark">
                ...
                <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
                    <li class="active"><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-gears"></i> Configurações</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="control-sidebar-home-tab">
                        <h3 class="control-sidebar-heading">Prazo para doação</h3>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Dias</label>
                                    <input class="form-control" id="days_donate" value="<?php echo $_SESSION['days_donate'];?>" name="days_donate" type="number" min="0">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <button class="btn btn-sm btn-default" onclick="cap_save_days_donate();"><i class="fa fa-check"></i> Salvar</button>    
                            </div>
                        </div>
